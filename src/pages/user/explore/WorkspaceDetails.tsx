...
//   };
//   const handleBookNow = () => {
//     if (availabilityStatus && bookingDetails) {
//       navigate('/checkout', {
//         state: { workspaceId, bookingDetails, workspace },
//         replace: false,
//       });
//       setTimeout(() => {
...
//           <AvailabilityChecker workspace={workspace} onAvailabilityChange={handleAvailabilityUpdate} />
...
import { pendingBookings, workspaceDetails } from "@/services/api/user";
import handleError from "@/utils/errorHandler";
import {
  Clock,
  Mail,
...
const WorkspaceDetails = () => {
  ...
  const [workspace, setWorkspace] = useState<workspaceData | null>(null);
  const [availabilityStatus, setAvailabilityStatus] = useState<boolean | null>(
    null
  );
  ...
  const handleBookNow = async () => {
    ...
    console.log("response bookingId", bookingId);

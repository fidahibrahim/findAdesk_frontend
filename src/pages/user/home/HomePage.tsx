          ...
          <div className="relative">
            <div className="flex justify-between items-center gap-8 px-8">
              {spaces.map((space, index) => (
                <div
                  key={index}
                  className={`relative flex-1 transition-opacity duration-300 ${Math.abs(currentSlide - index) <= 1 ? 'opacity-100' : 'opacity-50'
                    }`}
                >
                  <img
                    src={space.image}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center m z-0">
              <div className="max-w-2xl w-full px-4">
                ...
                <div className="space-y-6">
                  ...
                  <Link to="/explore">
                    <button className="w-full mt-6 bg-gray-800 text-white py-4 rounded-lg hover:bg-gray-700 transition-colors text-lg font-medium">
                      GET STARTED
                    </button>
                  </Link>
                </div>
